!(function(t, e) {
  if ("function" == typeof define && define.amd)
    define(["moment", "jquery"], function(t, a) {
      return a.fn ||
        (a.fn = {}), "function" != typeof t && t.default && (t = t.default), e(t, a);
    });
  ...
  var a = function(a, i, s) {
    ...
    if ("object" == typeof i.ranges) {
      ...
      this.showCustomRangeLabel &&
        (p +=
          ...
          '">' +
          this.locale.customRangeLabel +
          "</li>"), (p += "</ul>"), this.container.find(".ranges").prepend(p);
    }
    "function" == typeof s && (this.callback = s), this.timePicker ||
      ...
      ), this.timePicker && this.autoApply && (this.autoApply = !1), this
      .autoApply && this.container.addClass("auto-apply"), "object" ==
      typeof i.ranges && this.container.addClass("show-ranges"), this
      .singleDatePicker &&
      (
  ...
  return (a.prototype = {
    ...
    renderCalendar: function(a) {
      ...
      (Y += "<thead>"), (Y += "<tr>"), (this.showWeekNumbers ||
        ...
        (Y += "<th></th>"), (C && !C.isBefore(i.firstDay)) ||
      ...
      for (b = 0; b < 6; b++) {
        ...
        for (k = 0; k < 7; k++) {
          var N = [];
          i[b][k].isSame(new Date(), "day") && N.push("today"), i[b][
            k
          ].isoWeekday() > 5 && N.push("weekend"), i[b][k].month() !=
            i[1][1].month() && N.push("off"), this.minDate &&
            i[b][k].isBefore(this.minDate, "day") &&
            N.push("off", "disabled"), v &&
            i[b][k].isAfter(v, "day") &&
            N.push("off", "disabled"), this.isInvalidDate(i[b][k]) &&
            N.push("off", "disabled"), i[b][k].format("YYYY-MM-DD") ==
            this.startDate.format("YYYY-MM-DD") &&
            N.push("active", "start-date"), null != this.endDate &&
            i[b][k].format("YYYY-MM-DD") == this.endDate.format("YYYY-MM-DD") &&
            N.push("active", "end-date"), null != this.endDate &&
      ...
      if ("right" != t || this.endDate) {
        ...
        if (
          ...
          if (
            ...
            "PM" === r && a.hour() < 12 && a.hour(a.hour() + 12), "AM" === r &&
              12 === a.hour() &&
              a.hour(0);
          }
    ...
    monthOrYearChanged: function(t) {
      ...
      a ||
        ...
        ((n = this.minDate.month()), (r = this.minDate.year())), this.maxDate &&
        (r > this.maxDate.year() ||
